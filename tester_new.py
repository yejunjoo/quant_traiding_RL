...
def make_env_for_test(data_matrix, ticker_info_list, balance_rand, bankrupt_coef, termination_reward, max_balance, max_trade, window_size, fee_rate, stats_path):
...
def test():
    ...
    while not done:
        ...
        current_prices = raw_env.d_close[raw_env.timestep]
    ...
    stock_prices_gt = data_matrix[start_idx:start_idx+len(steps),:,0]
